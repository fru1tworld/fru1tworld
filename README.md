# Introduction 
안녕하세요. 분산 시스템, 데이터베이스, 네트워크에 관심이 많은 개발자에요. 
...
- [PR #5528](https://github.com/ktorio/ktor/pull/5528): Fix awaitContent returning true for closed empty channel (2026-04-16)
...
[![Codeforces](https://img.shields.io/badge/Codeforces-fru1t-1F8ACB?style=flat-square&logo=codeforces&logoColor=white)](https://codeforces.com/profile/fru1t)
...
# 레포 소개
## 요즘하고 있어요
[Code Kata](https://github.com/fru1tworld/code-kata)
- 다양한 언어로 코딩 연습을 하고 있어요.

[직접 만들면서 배우는 가상 면접 사례로 배우는 대규모 시스템 설계](https://github.com/fru1tworld/system-design-interview-practice)
- Kotlin, Ktor, Java, Spring 활용해서 책에서 배운 내용을 직접 구현해요.

[cs-study](https://github.com/fru1tworld/cs-study)
- 개인 CS 학습 레포에요. 각종 CS 책에 대한 개인적인 추천, 난이도가 포함되어 있고, 최근에는 다양한 자료를 모아서 읽고 있어요.
...
- WebSocket, CRDT 기술을 활용한 동시 편집 협업 플랫폼

[cs-basic](https://github.com/fru1tworld/cs-basic)
- cs-study에 있던 면접 질문지를 옮기고, 다양하게 공부할 수 있는 자료를 AI를 활용해서 첨부했어요.
